...
class FilesApi {
     ...
     */
    createFileAssociation(xeroTenantId_1, fileId_1, association_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, association, idempotencyKey, options = { headers: {} }) {
            ...
            let localVarRequestOptions = {
                ...
                data: models_1.ObjectSerializer.serialize(association, "Association"),
            };
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        body = models_1.ObjectSerializer.deserialize(response.data, "Association");
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createFolder(xeroTenantId_1, folder_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, folder, idempotencyKey, options = { headers: {} }) {
            ...
            let localVarRequestOptions = {
                ...
                url: localVarPath,
                responseType: responseTypeOption,
                data: models_1.ObjectSerializer.serialize(folder, "Folder"),
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.OAuth2.applyToRequest(localVarRequestOptions));
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "Folder");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     * @param fileId File id for single object
     */
    deleteFile(xeroTenantId_1, fileId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, options = { headers: {} }) {
     ...
     */
    deleteFileAssociation(xeroTenantId_1, fileId_1, objectId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, objectId, options = { headers: {} }) {
     ...
     */
    deleteFolder(xeroTenantId_1, folderId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, folderId, options = { headers: {} }) {
     ...
     */
    getAssociationsByObject(xeroTenantId_1, objectId_1, pagesize_1, page_1, sort_1, direction_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, objectId, pagesize, page, sort, direction, options = { headers: {} }) {
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "Array<Association>");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     */
    getAssociationsCount(xeroTenantId_1, objectIds_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, objectIds, options = { headers: {} }) {
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "object");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     * @param fileId File id for single object
     */
    getFile(xeroTenantId_1, fileId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Files/{FileId}'
                .replace('{' + 'FileId' + '}', encodeURIComponent(String(fileId)));
            let localVarQueryParameters = {};
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "FileObject");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     * @param fileId File id for single object
     */
    getFileAssociations(xeroTenantId_1, fileId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Files/{FileId}/Associations'
                .replace('{' + 'FileId' + '}', encodeURIComponent(String(fileId)));
            let localVarQueryParameters = {};
     ...
     * @param fileId File id for single object
     */
    getFileContent(xeroTenantId_1, fileId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, options = { headers: {} }) {
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "Buffer");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     */
    getFiles(xeroTenantId_1, pagesize_1, page_1, sort_1, direction_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, pagesize, page, sort, direction, options = { headers: {} }) {
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "Files");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     * @param folderId Folder id for single object
     */
    getFolder(xeroTenantId_1, folderId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, folderId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Folders/{FolderId}'
                .replace('{' + 'FolderId' + '}', encodeURIComponent(String(folderId)));
            let localVarQueryParameters = {};
     ...
     * @param sort values to sort by
     */
    getFolders(xeroTenantId_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, sort, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Folders';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
            ...
            return authenticationPromise.then(() => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield (0, axios_1.default)(localVarRequestOptions);
                        body = models_1.ObjectSerializer.deserialize(response.data, "Array<Folder>");
                        if (response.status && response.status >= 200 && response.status <= 299) {
                            resolve({ response: response, body: body });
                        }
                        else {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateFile(xeroTenantId_1, fileId_1, fileObject_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, fileId, fileObject, idempotencyKey, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Files/{FileId}'
                .replace('{' + 'FileId' + '}', encodeURIComponent(String(fileId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            ...
            let localVarRequestOptions = {
                ...
                url: localVarPath,
                responseType: responseTypeOption,
                data: models_1.ObjectSerializer.serialize(fileObject, "FileObject"),
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.OAuth2.applyToRequest(localVarRequestOptions));
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateFolder(xeroTenantId_1, folderId_1, folder_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, folderId, folder, idempotencyKey, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Folders/{FolderId}'
                .replace('{' + 'FolderId' + '}', encodeURIComponent(String(folderId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param mimeType
     */
    uploadFile(xeroTenantId_1, body_1, name_1, filename_1, idempotencyKey_1, mimeType_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, body, name, filename, idempotencyKey, mimeType, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Files';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
     ...
     * @param mimeType
     */
    uploadFileToFolder(xeroTenantId_1, folderId_1, body_1, name_1, filename_1, idempotencyKey_1, mimeType_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, folderId, body, name, filename, idempotencyKey, mimeType, options = { headers: {} }) {
