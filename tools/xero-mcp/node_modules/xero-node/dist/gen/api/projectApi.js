...
class ProjectApi {
     ...
     */
    createProject(xeroTenantId_1, projectCreateOrUpdate_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createTask(xeroTenantId_1, projectId_1, taskCreateOrUpdate_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, taskCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createTimeEntry(xeroTenantId_1, projectId_1, timeEntryCreateOrUpdate_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, timeEntryCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
     ...
     */
    deleteTask(xeroTenantId_1, projectId_1, taskId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, taskId, options = { headers: {} }) {
     ...
     */
    deleteTimeEntry(xeroTenantId_1, projectId_1, timeEntryId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, timeEntryId, options = { headers: {} }) {
     ...
     * @param projectId You can specify an individual project by appending the projectId to the endpoint
     */
    getProject(xeroTenantId_1, projectId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, options = { headers: {} }) {
     ...
     */
    getProjectUsers(xeroTenantId_1, page_1, pageSize_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, page, pageSize, options = { headers: {} }) {
     ...
     * @param pageSize Optional, it is set to 50 by default. The number of items to return per page in a paged response - Must be a number between 1 and 500.
     */
    getProjects(xeroTenantId_1, projectIds_1, contactID_1, states_1, page_1, pageSize_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectIds, contactID, states, page, pageSize, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
     ...
     */
    getTask(xeroTenantId_1, projectId_1, taskId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, taskId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}/Tasks/{taskId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'taskId' + '}', encodeURIComponent(String(taskId)));
     ...
     * @param chargeType
     */
    getTasks(xeroTenantId_1, projectId_1, page_1, pageSize_1, taskIds_1, chargeType_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, page, pageSize, taskIds, chargeType, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}/Tasks'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    getTimeEntries(xeroTenantId_1, projectId_1, userId_1, taskId_1, invoiceId_1, contactId_1, page_1, pageSize_1, states_1, isChargeable_1, dateAfterUtc_1, dateBeforeUtc_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, userId, taskId, invoiceId, contactId, page, pageSize, states, isChargeable, dateAfterUtc, dateBeforeUtc, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}/Time'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    getTimeEntry(xeroTenantId_1, projectId_1, timeEntryId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, timeEntryId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}/Time/{timeEntryId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'timeEntryId' + '}', encodeURIComponent(String(timeEntryId)));
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    patchProject(xeroTenantId_1, projectId_1, projectPatch_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, projectPatch, idempotencyKey, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateProject(xeroTenantId_1, projectId_1, projectCreateOrUpdate_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, projectCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateTask(xeroTenantId_1, projectId_1, taskId_1, taskCreateOrUpdate_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, taskId, taskCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}/Tasks/{taskId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'taskId' + '}', encodeURIComponent(String(taskId)));
            let localVarQueryParameters = {};
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    updateTimeEntry(xeroTenantId_1, projectId_1, timeEntryId_1, timeEntryCreateOrUpdate_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, projectId, timeEntryId, timeEntryCreateOrUpdate, idempotencyKey, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Projects/{projectId}/Time/{timeEntryId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'timeEntryId' + '}', encodeURIComponent(String(timeEntryId)));
            let localVarQueryParameters = {};
